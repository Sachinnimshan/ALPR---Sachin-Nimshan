...
% Last Modified by GUIDE v2.5 26-Aug-2018 16:14:04
...
while 1
    ...
    imgn=~fl;
    axes(handles.axes7); imshow(imgn); title('{\color{cyan}EXTRACTED PLATE}');
    ...
    for n=1:mx
        ...
        axes(handles.axes8); imshow(img_r);pause(1); title('{\color{cyan}EXTRACTING CHARACTERS}');
